...
#PIDS="$PIDS $!"
cd ~/PX4-Autopilot && HEADLESS=1 PX4_SYS_AUTOSTART=4001 PX4_GZ_MODEL_POSE="0,3" PX4_SIM_MODEL=gz_x500 ./build/px4_sitl_default/bin/px4 > "$LOG_DIR/px4_drone0.log" 2>&1 &
PIDS="$PIDS $!"
cd ~/PX4-Autopilot && HEADLESS=1 PX4_SYS_AUTOSTART=4001 PX4_GZ_MODEL_POSE="3,0" PX4_SIM_MODEL=gz_x500 ./build/px4_sitl_default/bin/px4 -i 1 > "$LOG_DIR/px4_drone1.log" 2>&1 & 
PIDS="$PIDS $!"
cd ~/PX4-Autopilot && HEADLESS=1 PX4_SYS_AUTOSTART=4001 PX4_GZ_MODEL_POSE="0,-3" PX4_SIM_MODEL=gz_x500 ./build/px4_sitl_default/bin/px4 -i 2 > "$LOG_DIR/px4_drone2.log" 2>&1 & 
PIDS="$PIDS $!"
cd ~/PX4-Autopilot && HEADLESS=1 PX4_SYS_AUTOSTART=4001 PX4_GZ_MODEL_POSE="-3,0" PX4_SIM_MODEL=gz_x500 ./build/px4_sitl_default/bin/px4 -i 3 > "$LOG_DIR/px4_drone3.log" 2>&1 & 
PIDS="$PIDS $!"
